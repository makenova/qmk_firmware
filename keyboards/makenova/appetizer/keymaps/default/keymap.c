...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_LALT, KC_LGUI,                KC_SPC,                      KC_RALT, MO1,     KC_LEFT, KC_DOWN, KC_RGHT
    ),
    LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_VOLU, KC_DEL,
    RGB_TOG, RGBF,    KC_TRNS,                   KC_TRNS,                    MO2,     KC_TRNS, KC_F14,  KC_VOLD, KC_F15
    ),
    LAYOUT(
