...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_P0, TD(TD_DOT_ENTER), KC_LEFT, KC_DOWN, KC_RGHT, KC_LAPO, KC_LGUI, LT(2,KC_SPC), LT(1,KC_SPC), KC_RGUI, KC_RALT, KC_RCPC
    ),
    LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_QUOT, KC_BSLS,
