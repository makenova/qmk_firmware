...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_P4, KC_P5, KC_P6, LCTL_T(KC_TAB), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, TD(TD_SEMI_QUOTE), LT(2,KC_ENT),
    KC_P1, KC_P2, KC_P3, KC_UP, TD(TD_LSHIFT_CURLY), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TD(TD_RSHIFT_CURLY),
    TD(TD_DOT_ENTER), LT(1, KC_P0), KC_LEFT, KC_DOWN, KC_RGHT, KC_LAPO, KC_LGUI, LT(1,KC_SPC), LT(1,KC_SPC), KC_RGUI, KC_RALT, KC_RCPC
    ),
    LAYOUT(
