...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_default(
    ...
    KC_PGDN, KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
             ...
             KC_LALT,           KC_LGUI, LT(1,KC_SPC),  KC_LGUI,                          LT(1,KC_SPC),           KC_RGUI,          KC_RALT
  ),
  [1] = LAYOUT_default(
    KC_ESC, KC_TILD,  KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,      KC_F7,   KC_F8,    KC_F9,    KC_F10,    KC_F11, KC_F12,  KC_BSLS, KC_DEL,
    KC_PGUP, KC_TAB,  KC_Q,    KC_UP,    KC_E,    KC_R,    KC_T,             KC_Y,   KC_U,    KC_UP,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_DEL,
    KC_PGDN, KC_LCTL, KC_LEFT,  KC_DOWN,    KC_RGHT,  KC_F,  KC_G,             KC_H,   KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_SCLN, KC_QUOT,   KC_ENT,
             KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, _______,
             KC_LALT,           KC_RGUI, LT(1,KC_SPC),  KC_RGUI,                          LT(1,KC_SPC),           KC_RGUI,          MO(2)
  ),
  [2] = LAYOUT_default(
