...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_default(
    ...
    KC_PGDN, KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
             ...
             MT(MOD_LCTL | MOD_LGUI | MOD_LALT, KC_NO), KC_LALT, KC_LGUI,  LT(1,KC_SPC),         LT(1,KC_SPC),     KC_RGUI,     KC_RALT
  ),
  [1] = LAYOUT_default(
    ...
    KC_PGUP, KC_TRNS, KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_TRNS,  KC_TRNS,     KC_TRNS,  KC_LEFT,   KC_DOWN,   KC_RGHT,    KC_TRNS, KC_TRNS,   KC_TRNS,
             ...
             KC_TRNS,           KC_TRNS, LT(1,KC_SPC),  KC_TRNS,                          LT(1,KC_SPC),           KC_TRNS,          MO(2)
  ),
  [2] = LAYOUT_default(
