...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT(
    ...
    SFT_Z,   KC_X,  KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, SFT_DOT,
    KC_LALT, KC_LGUI,        LT1_SPC,       OS_SHIFT, LT2_SLSH
  ),
  LAYOUT(
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,  KC_9,     KC_0,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_QUOT,
    KC_TRNS, KC_LBRC, KC_RBRC, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSLS, KC_MINS, KC_EQL,
    KC_TRNS, KC_TRNS,          KC_TRNS,        KC_TRNS, KC_TRNS
  ),
  LAYOUT(
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,
    KC_F11, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_F14, KC_F15,
    KC_LCBR, KC_LBRC, KC_LPRN, KC_TRNS, KC_TRNS, KC_TRNS, KC_RCBR, KC_VOLD, KC_VOLU,
